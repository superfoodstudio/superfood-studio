...
export type AdminOrdersPaginationQuery$variables = {
  after?: string | null;
  first?: number | null;
  status?: string | null;
};
export type AdminOrdersPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"pageOrdersPaginationFragment">;
};
export type AdminOrdersPaginationQuery = {
  response: AdminOrdersPaginationQuery$data;
  variables: AdminOrdersPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "AdminOrdersPaginationQuery",
    "selections": [
      {
        "args": null,
        "kind": "FragmentSpread",
