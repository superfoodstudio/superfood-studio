      ...
      <View direction="column" gap={4} padding={4}>
        ...
        <View direction="row" justify="end">
          <Button 
            ...
            disabled={isLoading || !data.cart || data.cart.items.length === 0}
          >
            Clear Cart
          </Button>
        </View>
        ...
        <View direction="row" justify="end" gap={2}>
          <Link href="/shop">
            <Button variant="outline" disabled={isLoading}>Continue Shopping</Button>
          </Link>
          <Button variant="solid" onClick={handleCheckout} disabled={isLoading}>Checkout</Button>
        </View>
      </View>
    );
  } catch (error) {
